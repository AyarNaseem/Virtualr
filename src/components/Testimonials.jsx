            ...
            <div key={i} className='w-full sm:w-1/2 lg:w-1/3 px-4 py-2'>
                <div className="bg-neutral rounded-md p-6 text-md border border-neutral-800 font-thin">
                    ...
                    <div className="flex mt-8 items-start">
                        <img className='h-12 w-12 mr-6 rounded-full border border-neutral-300' src={t.image} alt={t.user} />
                    <div>
                        <h6>{t.user}</h6>
                        <span className='text-sm font-normal italic text-neutral-600'>{t.company}</span>
                    </div>
                    </div>
                </div>
            </div>

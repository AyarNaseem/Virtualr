...
const Feature = () => {
  return (
    <div className="container my-20 border-b border-neutral-800 min-h-[800px]">
      
        <div className="text-center">
            <span className='bg-neutral-900 text-orange-500 rounded-full h-6 text-sm font-medium px-2 py-1 uppercase'>Feature</span>
            <h2 className=' text-3xl sm:text-4xl mt-10 lg:mt-20 tracking-wide'>Easily build {" "}
        ...
        <div className="flex flex-wrap mt-10 lg:mt-20">
          {features.map((feature,index)=>(
              <div key={index} className="w-full sm:w-1/2 lg:w-1/3" >
                 ...
                 <h5 className='mt-1 mb-6 text-xl text-net'>{feature.text}</h5>
